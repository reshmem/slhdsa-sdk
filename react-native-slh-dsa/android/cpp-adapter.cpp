...
// Automated testing checks Java_com_slhdsa_SlhDsaModule and slhdsa
// by comparing the whole line here.
/*
Java_com_slhdsa_SlhDsaModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return slhdsa::multiply(a, b);
}
*/

// Installer coming from SlhDsaModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_slhdsa_SlhDsaModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return slhdsa::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_slhdsa_SlhDsaModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return slhdsa::cleanupRustCrate(*runtime);
}